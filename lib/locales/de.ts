...
export const deUi: Record<string, string> = {
  ...
  "Include expenses and income to show the net amount for each label.": "Ausgaben und Einnahmen zum Nettobetrag jedes Labels verrechnen.",
  "Labels in the chart": "Labels im Diagramm",
  "Select all": "Alle auswählen",
  "Save settings": "Einstellungen speichern",
  "Net expenses and income; selected labels are shown separately and everything else is Other": "Netto aus Ausgaben und Einnahmen; ausgewählte Labels werden separat dargestellt, alles andere unter Sonstiges",
  "Period": "Zeitraum",
  "All": "Alle",
  "Other": "Sonstiges",
  ...
  "Set the starting amount for each currency.": "Startbetrag für jede Währung festlegen.",
  "Starting amounts": "Startbeträge",
  "Starting amounts are added to the imported transaction total.": "Startbeträge werden zur Summe der importierten Transaktionen addiert.",
  ...
  "Income offsets expenses within each label. Pie sizes use the magnitude of each resulting net amount.": "Einnahmen werden innerhalb jedes Labels mit Ausgaben verrechnet. Die Segmentgrösse entspricht dem Betrag des resultierenden Nettowerts.",
  ...
  "Each file must contain exactly one wallet. Existing transactions for that wallet are replaced.": "Jede Datei muss genau ein Portemonnaie enthalten. Bestehende Transaktionen dieses Portemonnaies werden ersetzt.",
  ...
  "Could not save label selection.": "Die Label-Auswahl konnte nicht gespeichert werden.",
  ...
  "Labels must be a list of label names.": "Labels müssen als Liste von Label-Namen angegeben werden.",
