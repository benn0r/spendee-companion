  ...
  return (
    <section className="transaction-filters" aria-label="Transaction filters" ref={panelRef}>
      <div className="filter-row">
        ...
        <MultiFilter label="Types" options={options.types} selected={value.types} onChange={(types) => update({ types })} />
        <MultiFilter label="Categories" options={options.categories} selected={value.categories} onChange={(categories) => update({ categories })} />
        <MultiFilter label="Tags" options={options.tags} selected={value.tags} onChange={(tags) => update({ tags })} />
